...
export const metadata = {
  title: "من نحن | شركة جلي رخام | يلا عمار",
  description: "تعرف على مؤسسة يلا عمار، الشركة الرائدة والأفضل في السعودية لخدمات تركيب وجلي الرخام، السيراميك، والبورسلين. نقدم خدماتنا في جدة، مكة، والطائف.",
  alternates: {
    canonical: '/about',
  }
};
